...
class MCReactModule {
     ...
     * @returns  {Promise<object[]>} A promise to the array of objects representing Inbox messages that are already downloaded in the native SDK.
     ...
     * @returns  {Promise<boolean>} A promise to the boolean representation indicatating success in setting the message to read.
     * @see  {@link https://salesforce-marketingcloud.github.io/MarketingCloudSDK-Android/in-app-message/in-app-messaging.html|Android Docs}
     ...
     * @returns  {Promise<object[]>} A promise to the array of objects representing Inbox messages that are already downloaded and read in the native SDK.
     * @see  {@link https://salesforce-marketingcloud.github.io/MarketingCloudSDK-Android/in-app-message/in-app-messaging.html|Android Docs}
     * @see  {@link https://salesforce-marketingcloud.github.io/MarketingCloudSDK-iOS/appledoc/Classes/MarketingCloudSDK.html#//api/name/sfmc_getUnreadMessages|iOS Docs}
     */
    ...
    /**
     * Returns all read inbox messages already downloaded and read from the  Marketing Cloud SDK.
     * @returns  {Promise<object[]>} A promise to the array of objects representing Inbox messages that are already downloaded and deleted in the native SDK.
     * @see  {@link https://salesforce-marketingcloud.github.io/MarketingCloudSDK-Android/in-app-message/in-app-messaging.html|Android Docs}
     * @see  {@link https://salesforce-marketingcloud.github.io/MarketingCloudSDK-iOS/appledoc/Classes/MarketingCloudSDK.html#//api/name/sfmc_getUnreadMessages|iOS Docs}
     */
    ...
    /**
     * Return count of all active Inbox messages already downloaded from the MarketingCloud SDK.
